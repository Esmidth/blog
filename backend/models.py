...
class Tag(models.Model):
    tag_name = models.CharField(max_length=50, blank=False, default='uncategoried')
...
class Article(models.Model):
    ...
    tag = models.ForeignKey(Tag, on_delete=models.CASCADE, default=None, null=True, blank=True)
